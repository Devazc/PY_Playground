#A Simple calculator with Simple Interface
...
window = tk.Tk()
window.title("Calculator - Simple and Efficient")
...
button_mul =tk.Button(master=frame,text="x",padx=15,pady=5,width=3,command=lambda:myclick("*"))
button_mul.grid(row=5,column=0,columnspan=1,pady=2)
...
button_equal.grid(row=5,column=1,pady=2)
